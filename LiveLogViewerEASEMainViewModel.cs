...
namespace VNCLogViewer.Presentation.ViewModels
{
    ...
    {
        private ILiveLogViewerEASELookupDataService _lookupDataService;
        private IEventAggregator _eventAggregator;

        private Func<ILiveLogViewerEASEDetailViewModel> _detailViewModelCreator;
        ...
        public ILiveLogViewerEASENavigationViewModel NavigationViewModel { get; }

        public LiveLogViewerEASEMainViewModel(
            ILiveLogViewerEASENavigationViewModel navigationViewModel,
            Func<ILiveLogViewerEASEDetailViewModel> detailViewModelCreator,
            // ILiveLogViewerEASELookupDataService lookupDataService,
        ...
        public ObservableCollection<NavigationItemViewModel> LiveLogViewerEASEs { get; }
        ...
        NavigationItemViewModel _selectedLiveLogViewerEASE;

        public NavigationItemViewModel SelectedLiveLogViewerEASE
        {
            get { return _selectedLiveLogViewerEASE; }
            set
            {
                _selectedLiveLogViewerEASE = value;
                OnPropertyChanged();

                if (_selectedLiveLogViewerEASE != null)
                {
                    _eventAggregator.GetEvent<OpenLiveLogViewerEASEDetailViewEvent>()
                      .Publish
                        (
                            ...
                            {
                                Id = _selectedLiveLogViewerEASE.Id,
                                ViewModelName = nameof(LiveLogViewerEASEDetailViewModel)
                            }
                        );
                }
            }
        ...
        private async void OnOpenDetailView(OpenDetailViewEventArgs args)
        {
            ...
            if (detailViewModel == null)
            {
                ...
                {
                    case nameof(LiveLogViewerEASEDetailViewModel):
