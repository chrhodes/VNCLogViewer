...
{
    public class LiveLogViewerEASENavigationViewModel : ViewModelBase, ILiveLogViewerEASENavigationViewModel
    {
        ...
        public LiveLogViewerEASENavigationViewModel(
                ...
                ILiveLogViewerEASELookupDataService lookupDataService)
        {
            ...
            LiveLogViewerEASEs = new ObservableCollection<NavigationItemViewModel>();
        ...
        public async Task LoadAsync()
        {
            ...
            var lookupF = await _lookupDataService.GetLiveLogViewerEASELookupAsync();
            LiveLogViewerEASEs.Clear();

            foreach (var item in lookupF)
            {
                LiveLogViewerEASEs.Add(
                    new NavigationItemViewModel(item.Id, item.DisplayMember,
                    nameof(LiveLogViewerEASEDetailViewModel),
                    _eventAggregator));
            }
        ...
        private void AfterDetailSaved(AfterDetailSavedEventArgs args)
        {
            ...
            switch (args.ViewModelName)
            {
                case nameof(LiveLogViewerEASEDetailViewModel):
                    AfterDetailSaved(LiveLogViewerEASEs, args);
                    break;
        ...
        private void AfterDetailDeleted(AfterDetailDeletedEventArgs args)
        {
            ...
            {
                case nameof(LiveLogViewerEASEDetailViewModel):
                    AfterDetailDeleted(LiveLogViewerEASEs, args);
                    break;
