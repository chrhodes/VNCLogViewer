...
{
    public class LiveLogViewerVNCDetailViewModel : DetailViewModelBase, ILiveLogViewerVNCDetailViewModel
    {
        private ILiveLogViewerVNCDataService _dataService;
        private IEventAggregator _eventAggregator;

        public LiveLogViewerVNCDetailViewModel(
                ILiveLogViewerVNCDataService dataService,
        ...
        public override async Task LoadAsync(int id)
        {
            ...
            var item = id > 0
                ...
                : CreateNewLiveLogViewerVNC();

            Id = item.Id;

            InitializeLiveLogViewerVNC(item);
        ...
        private LiveLogViewerVNCWrapper _type;

        public LiveLogViewerVNCWrapper Type
        {
            get { return _type; }
            private set
            {
        ...
        private void InitializeLiveLogViewerVNC(LiveLogViewerVNC item)
        {
            Int64 startTicks = Log.VIEWMODEL("Enter", Common.LOG_APPNAME);

            Type = new LiveLogViewerVNCWrapper(item);
        ...
        protected override async void OnDeleteExecute()
        {
            ...
            var result = MessageDialogService.ShowOkCancelDialog(
                "Do you really want to delete the LiveLogViewerVNC?", "Question");
        ...
        private Domain.LiveLogViewerVNC CreateNewLiveLogViewerVNC()
        {
            Int64 startTicks = Log.VIEWMODEL("Enter", Common.LOG_APPNAME);

            var item = new Domain.LiveLogViewerVNC();
