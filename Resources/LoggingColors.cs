...
namespace VNCLogViewer.Resources
{
    ...
    public class LoggingColors
    {
        ...
        public Color Trace01 { get; set; } = Color.FromArgb(255, 0, 0); //.Red; // EVENT_HANDLER
        public Color Trace02 { get; set; } = Color.FromArgb(210, 210, 210); //.LightGray; // APPLICATION_INITIALIZE
        ...
        public Color Trace09 { get; set; } = Color.FromArgb(170, 170, 170);// .DarkGray; // CORE
        ...
        public Color Trace16 { get; set; } = Color.FromArgb(255, 255, 255); //.White; // INFRASTRUCTURE
        ...
        public Color Trace19 { get; set; } = Color.FromArgb(255, 0, 255); //.Fuchsia; // MODULE
        ...
        public Color Trace25 { get; set; } = Color.FromArgb(221, 160, 221); // Plum; // CONSTRUCTOR
        public Color Trace26 { get; set; } = defaultColor;
        public Color Trace27 { get; set; } = Color.FromArgb(0, 200, 200); // VIEW_LOW
        public Color Trace28 { get; set; } = Color.FromArgb(0, 255, 255); // Aqua; // VIEWMODEL_LOW
        public Color Trace29 { get; set; } = Color.FromArgb(255, 219, 255); //.Fuchsia; // MODULE_INITIALIZE;
