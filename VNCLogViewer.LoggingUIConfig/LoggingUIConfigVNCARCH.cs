...
namespace VNCLogViewer.LoggingUIConfig
{
    public class LoggingUIConfigVNCARCH : LoggingUIConfig
    {
        ...
        {
            Name = "VNCARCH Custom Filter";

            Arch00 = new LoggingLevel { Label = "CONSTRUCTOR", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(200, 200, 200), IsChecked = true, ToolTip = "CONSTRUCTOR / Arch00" };
            Arch01 = new LoggingLevel { Label = "EVENT", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(255, 0, 0), IsChecked = true, ToolTip = "EVENT / Arch01" };
            Arch02 = new LoggingLevel { Label = "EVENT_HANDLER", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(200, 200, 200), IsChecked = true, ToolTip = "EVENT_HANDLER / Arch02" };
            Arch03 = new LoggingLevel { Label = "APPLICATION_INITIALIZE", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(200, 200, 200), IsChecked = true, ToolTip = "APPLICATION_INITIALIZE / Arch03" };
            Arch04 = new LoggingLevel { Label = "CORE", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(200, 200, 200), IsChecked = true, ToolTip = "CORE / Arch04" };
            Arch05 = new LoggingLevel { Label = "MODULE", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(200, 200, 200), IsChecked = true, ToolTip = "MODULE / Arch05" };
            Arch06 = new LoggingLevel { Label = "MODULE_INITIALIZE", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(200, 200, 200), IsChecked = true, ToolTip = "MODULE_INITIALIZE / Arch06" };
            Arch07 = new LoggingLevel { Label = "APPLICATION", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(200, 200, 200), IsChecked = true, ToolTip = "APPLICATION / Arch07" };
            Arch08 = new LoggingLevel { Label = "APPLICATIONSERVICES", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(200, 200, 200), IsChecked = true, ToolTip = "APPLICATIONSERVICES / Arch08" };
            Arch09 = new LoggingLevel { Label = "DOMAIN", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(200, 200, 200), IsChecked = true, ToolTip = "DOMAIN / Arch09" };
            Arch10 = new LoggingLevel { Label = "DOMAINSERVICES", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(0, 255, 255), IsChecked = true, ToolTip = "DOMAINSERVICES / Arch10" };
            Arch11 = new LoggingLevel { Label = "PERSISTENCE", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(100, 240, 100), IsChecked = true, ToolTip = "PERSISTENCE / Arch11" };
            Arch12 = new LoggingLevel { Label = "PERSISTENCE_LOW", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(255, 180, 0), IsChecked = true, ToolTip = "PERSISTENCE_LOW / Arch12" };
            Arch13 = new LoggingLevel { Label = "INFRASTRUCTURE", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(186, 85, 211), IsChecked = true, ToolTip = "INFRASTRUCTURE / Arch13" };
            Arch14 = new LoggingLevel { Label = "PRESENTATION", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(200, 200, 200), IsChecked = true, ToolTip = "PRESENTATION / Arch14" };
            Arch15 = new LoggingLevel { Label = "VIEW", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(200, 200, 200), IsChecked = true, ToolTip = "VIEW / Arch15" };
            Arch16 = new LoggingLevel { Label = "VIEW_LOW", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(200, 200, 200), IsChecked = true, ToolTip = "VIEW_LOW / Arch16" };
            Arch17 = new LoggingLevel { Label = "VIEWMODEL", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(200, 200, 200), IsChecked = true, ToolTip = "VIEWMODEL / Arch17" };
            Arch18 = new LoggingLevel { Label = "VIEWMODEL_LOW", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(200, 200, 200), IsChecked = true, ToolTip = "VIEWMODEL_LOW / Arch18" };
            Arch19 = new LoggingLevel { Label = "Arch19", Visibility = System.Windows.Visibility.Visible, Color = Color.FromArgb(200, 200, 200), IsChecked = true, ToolTip = "Arch19" };
    }
        //public string Name { get; set; } = "VNCARCH Custom Filter";
